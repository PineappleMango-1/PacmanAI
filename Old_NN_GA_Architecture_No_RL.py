...
model = NN_Basic(X.shape[0], Y.shape[0], lossfn = CE_loss, activation = relu, layers = 3, nodes_b = 150, nodes_h1 = 50, nodes_h2 = 25, nodes_h3 = 10)
acc_level(model, X, Y, X_test, Y_test, model_accuracy, n_epochs=50, batch_size=4, lr=0.01, lr_decay=1)
test = model.f_pass(X)
print(test[:,0])
i = 0
